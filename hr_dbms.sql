use hr_dbms;
CREATE TABLE hr_dbms.regions (
	region_id INT (11) AUTO_INCREMENT PRIMARY KEY,
	region_name VARCHAR (25) DEFAULT NULL
);

CREATE TABLE hr_dbms.countries (
...
CREATE TABLE hr_dbms.locations (
...
CREATE TABLE hr_dbms.departments (
...
CREATE TABLE hr_dbms.employees (
...
CREATE TABLE hr_dbms.dependents (
